          ...
          <div className="mt-8 border-t border-slate-700/50 pt-6 relative z-20">
            <div className="flex items-center justify-center gap-4">
              <button 
                ...
                className="flex items-center justify-center w-full px-4 py-2.5 rounded-xl bg-slate-800/80 hover:bg-slate-700 border border-slate-700/50 transition-colors text-sm font-medium gap-2 text-slate-200"
              >
